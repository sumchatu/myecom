                        ...
                        <div class="main_nav_content d-flex flex-row">
                            ...
                            <div class="cat_menu_container">
                                ...
                                <ul class="cat_menu">
                                    ...
                                    <li class="hassubs">
                                        <a href="{{route('category.products',$cat->id)}}">{{$cat->category_name}}<i class="fas fa-chevron-right"></i></a>
                                        <ul>
                                            @foreach($cat->subcategories as $subcat)
                                            <li class="hassubs">
                                                <a href="{{route('subcat.products',$subcat->id)}}">{{$subcat->subcategory_name}}<i class="fas fa-chevron-right"></i></a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </li>
