...
<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/styles/shop_responsive.css')}}">
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">{{$subcat->subcategory_name}}</h2>
		</div>
	</div>
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="{{route('category.products',$cat->id)}}">{{$cat->category_name}}</a></li>
								@endforeach
							</ul>
						</div>
					...
					<div class="shop_content">
						...
						<div class="product_grid row">
							...
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('public/media/product/'.$product->image_one)}}" alt="" style="height: 100px; "></div>
