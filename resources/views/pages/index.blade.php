...
<div class="characteristics">
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                               ...
                               @foreach($hotDealProduct as $product) 
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="{{ asset('public/media/product/'.$product->image_one)}}" alt=""></div>
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"><a href="#">{{$product->category->category_name}}</a></div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset('public/media/product/'.$product->image_one)}}" alt="" style="height: 120px; width: 140px">
                                            </div>
                                            <div class="product_content">
                                                ...
                                                <!-- <div class="product_extras">
                                                    <button class="product_cart_button add-to-cart" data-id="{{$product->id}}">Add to Cart</button>
                                                </div> -->
                                                <div class="product_extras">
                                                    <button id="{{$product->id}}" class="product_cart_button add-to-cart" data-toggle="modal" data-target="#cartModal" onclick="productview(this.id)">Add to Cart</button>
                                                </div>
                                            </div>
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_text">
                                            <h4>{{$product->brand->brand_name}}</h4><br>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="{{ asset('public/media/product/'.$product->image_one)}}" alt="" style="height: 300px; width: 250px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>          
                ...
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{$category1->category_name}}</div>
                            <ul class="clearfix">
                                <li class="active"></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="z-index:1;">
                                ...
                                <div class="product_panel panel active">
                                    ...
                                    @foreach($category1->products->take(10) as $product)
                                    <!-- Slider Item -->
                                    <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{$category2->category_name}}</div>
                            <ul class="clearfix">
                                <li class="active"></li>
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="z-index:1;">
                                ...
                                <div class="product_panel panel active">
                                    ...
                                    @foreach($category2->products->take(10) as $product)
                                    <!-- Slider Item -->
                                    <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-9">
                    <div class="trends_slider_container">
                        ...
                        <div class="owl-carousel owl-theme trends_slider">
                            ...
                            @foreach($buy1get1Product as $product)
                            <!-- Buy one get one Slider Item -->
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    <div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('public/media/product/'.$product->image_one)}}" alt=""></div>
                                    <div class="trends_content">
                                        <div class="trends_category"><a href="#">{{$product->brand->brand_name}}</a></div>
                                        <div class="trends_info clearfix">
                                            <div class="trends_name"><a href="">{{$product->product_name}}</a></div>
                                            @if($product->discount_price == NULL)
                                                <div class="product_price discount">₹{{$product->selling_price }}</div>
                                            @else
                                                <div class="product_price discount">₹{{$product->discount_price }}<span>₹{{$product->selling_price }}</span></div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="" id="pImage" class="text-center" style="height: 220px;width: 230px;">
                        <div class="card-body">
    ...
    <script type="text/javascript">
        function productview(id){
            $.ajax({
                type:"GET",
                url : "{{url('product/quick/details')}}/"+id,
                dataType: "json",
                success:function(data){
                    ...
                    $('#pCat').text(data.product_category);
                    $('#pSubCat').text(data.product_subCategory);
                    $('#pBrand').text(data.product_brand);
                    $('#pImage').attr('src','public/media/product/'+data.product.image_one);
