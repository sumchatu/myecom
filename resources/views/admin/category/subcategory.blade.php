            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              @foreach($subcategory as $key=>$row)
                <tr>
                  ...
                  <td>
                  <a href="{{route('subcategory.edit',Crypt::encrypt($row->id))}}" class="btn btn-sm btn-info">Edit</a>
                  {!! Form::open(['method' => 'DELETE','route' => ['subcategory.destroy', $row->id],'style'=>'display:inline']) !!}
