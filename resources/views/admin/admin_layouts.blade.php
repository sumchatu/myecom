   ...
   @else
    ...
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('coupon.index')}}" class="nav-link">Active-Coupons</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('admin.newsletter')}}" class="nav-link">News Letters</a></li>
        </ul>
